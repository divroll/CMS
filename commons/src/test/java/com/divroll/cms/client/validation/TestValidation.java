...
import com.divroll.cms.client.model.ContentWrapper;
...
public class TestValidation {
    ...
    public void test() {
        ...
        Set<ConstraintViolation<ContentWrapper>> violation = ContentValidator.validate(content, DraftValidationGroup.class);
